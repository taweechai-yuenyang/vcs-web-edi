...
class VcsBooking(models.Model):
    ...
    name = fields.Char(size=255,string="Name", tracking=True, required=True)
    code = fields.Char(size=50,string="Code", tracking=True, required=True)
    prefix = fields.Char(size=50,string="Code", tracking=True) # prefix = models.CharField(size=250, string="Prefix", blank=True, null=True)
    description = fields.Text(string="Description", tracking=True)
    is_active = fields.Boolean(string="Is Active", tracking=True, default=False)
...
class VcsUploadForecast(models.Model):
    ...
    forecast_date = fields.Date(string="Forecast Date", tracking=True, default=lambda self: fields.Date.today())# forecast_date = models.DateField(string="Date", default=timezone.now, blank=True, null=True)
...
class VcsForecastErrorLogs(models.Model):
    ...
    part_code = fields.Char(size=255,string="Part Code", tracking=True, required=True)# part_code = models.CharField(size=50, string="Part Code")
    part_no = fields.Char(size=255,string="Part No.", tracking=True, required=True)# part_no = models.CharField(size=50, string="Part No.")
    part_name = fields.Char(size=255,string="Part Name", tracking=True, required=True)# part_name = models.CharField(size=50, string="Part Name")
    supplier = fields.Char(size=255,string="Supplier", tracking=True, required=True)# supplier = models.CharField(size=50, string="Supplier")
    model = fields.Char(size=255,string="Model", tracking=True, required=True)# model = models.CharField(size=50, string="Model")
    rev_0 = fields.Integer(string='Rev. 0',tracking=True)# rev_0 = models.IntegerField(string="Rev.0",default=0, blank=True, null=True)
    rev_1 = fields.Integer(string='Rev. 1',tracking=True)# rev_1 = models.IntegerField(string="Rev.1",default=0, blank=True, null=True)
    rev_2 = fields.Integer(string='Rev. 2',tracking=True)# rev_2 = models.IntegerField(string="Rev.2",default=0, blank=True, null=True)
    rev_3 = fields.Integer(string='Rev. 3',tracking=True)# rev_3 = models.IntegerField(string="Rev.3",default=0, blank=True, null=True)
    rev_4 = fields.Integer(string='Rev. 4',tracking=True)# rev_4 = models.IntegerField(string="Rev.4",default=0, blank=True, null=True)
    rev_5 = fields.Integer(string='Rev. 5',tracking=True)# rev_5 = models.IntegerField(string="Rev.5",default=0, blank=True, null=True)
    rev_6 = fields.Integer(string='Rev. 6',tracking=True)# rev_6 = models.IntegerField(string="Rev.6",default=0, blank=True, null=True)
    rev_7 = fields.Integer(string='Rev. 7',tracking=True)# rev_7 = models.IntegerField(string="Rev.7",default=0, blank=True, null=True)
    remark = fields.Text(string="Remark", tracking=True)# remark = models.TextField(string="Remark", blank=True, null=True)
    is_error = fields.Boolean(string="Is Error", tracking=True, default=False)# is_error = fields.Boolean(string="Is Error", default=True, blank=True, null=True)
    is_success = fields.Boolean(string="Is Success", tracking=True, default=False)# is_success = fields.Boolean(string="Is Success", default=False, blank=True, null=True)
...
class VcsForecast(models.Model):
    ...
    forecast_no = fields.Char(size=15,string="Forecast No.", tracking=True, required=True)# forecast_no = models.CharField(size=15,string="Request No.", blank=True, null=True)
    ...
    forecast_m0 = fields.Float(string="Month 0", tracking=True, default="0")# forecast_m0 = models.FloatField(string="Month 0", blank=True, null=True, default="0")
    forecast_m1 = fields.Float(string="Month 1", tracking=True, default="0")# forecast_m1 = models.FloatField(string="Month 1", blank=True, null=True, default="0")
    forecast_m2 = fields.Float(string="Month 2", tracking=True, default="0")# forecast_m2 = models.FloatField(string="Month 2", blank=True, null=True, default="0")
    forecast_m3 = fields.Float(string="Month 3", tracking=True, default="0")# forecast_m3 = models.FloatField(string="Month 3", blank=True, null=True, default="0")
    remark = fields.Text(string="Remark", tracking=True)# remark = models.TextField(string="Remark", blank=True, null=True)
    forecast_by_id = fields.Many2one('res.users',string="User ID", required=True, tracking=True)# forecast_by_id = models.ForeignKey(ManagementUser, string="Request By ID", blank=True, null=True, on_delete=models.SET_NULL)
    forecast_status = fields.Selection([('0', 'รออนุมัติเปิด PR'),('1', 'อนุมัติเปิด PR'),('2', 'เปิด PR แล้ว'),('3', 'ไม่อนุมัติ'),], string="Status", tracking=True, default="0")# forecast_status = models.CharField(size=1, choices=FORECAST_ORDER_STATUS,string="Request Status", default="0")
    ...
    ref_formula_id = fields.Char(size=8,string="Formula ID", tracking=True)# ref_formula_id = models.CharField(size=8, string="Ref. Formula ID", blank=True, null=True)
    is_po = fields.Boolean(string="Is PO", tracking=True, default=False)# is_po = fields.Boolean(string="Is PO", default=False, blank=True, null=True)
    is_sync = fields.Boolean(string="Is Sync", tracking=True, default=False)# is_sync = fields.Boolean(string="Is Sync", default=True, blank=True, null=True)
...
class VcsForecastDetail(models.Model):
    ...
    seq = fields.Integer(string="Seq", tracking=True, default="0")# seq = models.IntegerField(string="#", blank=True, null=True,default="0")
    ...
    month_0 = fields.Integer(string="Month 0", tracking=True, default="0")# month_0 = models.IntegerField(string="Month 0", blank=True, null=True, default="0")
    month_1 = fields.Integer(string="Month 1", tracking=True, default="0")# month_1 = models.IntegerField(string="Month 1", blank=True, null=True, default="0")
    month_2 = fields.Integer(string="Month 2", tracking=True, default="0")# month_2 = models.IntegerField(string="Month 2", blank=True, null=True, default="0")
...
class VcsPDS(models.Model):
    ...
    approve_by_id = fields.Many2one('res.users',string='Approve By', required=True, tracking=True)# approve_by_id = models.ForeignKey(ManagementUser, string="Approve By ID", blank=True, null=True, on_delete=models.SET_NULL)
    ...
    supplier_id = fields.Many2one('res.partner',string='Supplier ID', required=True, tracking=True)# supplier_id = models.ForeignKey(Supplier, string="Supplier ID", blank=True, null=True, on_delete=models.SET_NULL)
    ...
    pds_date = fields.Date(string="PDS Date", tracking=True)# pds_date = models.DateField(string="PDS Date", blank=True, null=True)
    delivery_date = fields.Date(string="Delivery Date", tracking=True)# pds_delivery_date = models.DateField(string="Delivery Date", blank=True, null=True)
    pds_no = fields.Char(string="PDS No.", required=True, tracking=True)# pds_no = models.CharField(size=15,string="PDS No.", blank=True, null=True)
    ...
    balance_qty = fields.Integer(string="Balance Qty", tracking=True, default="0")# balance_qty = models.IntegerField(string="Total Qty", blank=True, null=True, default="0")
    summary_price = fields.Float(string="Summary Price", tracking=True, default="0")# summary_price = models.FloatField(string="Summary Price", blank=True, null=True, default="0")
    remark = fields.Text(string="Remark", tracking=True)# remark = models.TextField(string="Remark", blank=True, null=True)
    status = fields.Selection([(0, "รอเปิด PO"),(1, "เปิด PO บางส่วน"),(2, "เสร็จสมบูรณ์"),(3, "-"),(4, "-")], string="Status", tracking=True, default="0")# pds_status = models.CharField(size=1, choices=FORECAST_PDS_STATUS,string="PDS Status", blank=True, null=True, default="0")
    download_count = fields.Integer(string="Download Count", tracking=True, default="0")# pds_download_count = models.IntegerField(string="Download Count", blank=True, null=True)
    ref_formula_id = fields.Char(size=8,string="Formula ID", tracking=True)
