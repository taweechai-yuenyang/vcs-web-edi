...
class VcsForecastErrorLogs(models.Model):
    ...
    row_num = fields.Integer(string="Row", tracking=True)# row_num = fields.Interger(string="Row")
    ...
    rev_0 = fields.Integer(string='Rev. 0',tracking=True)# rev_0 = fields.Interger(string="Rev.0",default=0)
    rev_1 = fields.Integer(string='Rev. 1',tracking=True)# rev_1 = fields.Interger(string="Rev.1",default=0)
    rev_2 = fields.Integer(string='Rev. 2',tracking=True)# rev_2 = fields.Interger(string="Rev.2",default=0)
    rev_3 = fields.Integer(string='Rev. 3',tracking=True)# rev_3 = fields.Interger(string="Rev.3",default=0)
    rev_4 = fields.Integer(string='Rev. 4',tracking=True)# rev_4 = fields.Interger(string="Rev.4",default=0)
    rev_5 = fields.Integer(string='Rev. 5',tracking=True)# rev_5 = fields.Interger(string="Rev.5",default=0)
    rev_6 = fields.Integer(string='Rev. 6',tracking=True)# rev_6 = fields.Interger(string="Rev.6",default=0)
    rev_7 = fields.Integer(string='Rev. 7',tracking=True)# rev_7 = fields.Interger(string="Rev.7",default=0)
...
class VcsForecast(models.Model):
    ...
    forecast_item = fields.Integer(string="Item", tracking=True, default="0")# forecast_item = fields.Interger(string="Item", , default="0")
    ...
    forecast_download_count = fields.Integer(string="Download Count", tracking=True)# forecast_download_count = fields.Interger(string="Download Count",  ,  default="0")
...
class VcsForecastDetail(models.Model):
    ...
    seq = fields.Integer(string="Seq", tracking=True, default="0")# seq = fields.Interger(string="#",default="0")
    request_qty = fields.Float(string="Request Qty", tracking=True, default="0")# request_qty = fields.Interger(string="Request Qty.", default="0.0")
    balance_qty = fields.Float(string="Balance Qty", tracking=True, default="0")# balance_qty = fields.Interger(string="Total Qty.", default="0.0")
    price = fields.Float(string="Price", tracking=True, default="0")# price =fields.Float(string="Price.", , default="0")
    month_0 = fields.Integer(string="Month 0", tracking=True, default="0")# month_0 = fields.Interger(string="Month 0", default="0")
    month_1 = fields.Integer(string="Month 1", tracking=True, default="0")# month_1 = fields.Interger(string="Month 1", default="0")
    month_2 = fields.Integer(string="Month 2", tracking=True, default="0")# month_2 = fields.Interger(string="Month 2", default="0")
...
class VcsPDS(models.Model):
    ...
    item = fields.Integer(string="Item", tracking=True, default="0")# item = fields.Interger(string="Item")
    qty = fields.Integer(string="Qty", tracking=True, default="0")# qty = fields.Interger(string="Qty")
    balance_qty = fields.Integer(string="Balance Qty", tracking=True, default="0")# balance_qty = fields.Interger(string="Total Qty", default="0")
    ...
    download_count = fields.Integer(string="Download Count", tracking=True, default="0")# pds_download_count = fields.Interger(string="Download Count")
    ref_formula_id = fields.Char(size=8,string="Formula ID", tracking=True)
...
class VcsReportPDSDetail(models.Model):
    ...
    packing_qty = fields.Interger(string="Packing", tracking=True, default="0")# itemPartPack
    total = fields.Interger(string="Total", tracking=True, default="0")# itemTotal
    is_active = fields.Boolean(string="Is Active", tracking=True, default=False)
...
class VcsConfirmInvoiceHeader(models.Model):
    ...
    approve_by_id = fields.Many2one('res.user', string="Approve By ID", required=True, tracking=True)
    ...
    item = fields.Interger(string="Item", required=True, tracking=True)
    qty = fields.Interger(string="Qty", required=True, tracking=True)
    confirm_qty = fields.Interger(string="Confirm Qty", tracking=True,default="0")
    ...
    ref_formula_id = fields.Char(size=8, string="Formula ID", tracking=True)
    is_download_count = fields.Interger(string="Download Count", tracking=True, default="0")# itemTotal
    is_active = fields.Boolean(string="Is Active", tracking=True, default=False)
...
class VcsConfirmInvoiceDetail(models.Model):
    ...
    seq = fields.Interger(string="Seq.",tracking=True, default="0")
    qty = fields.Interger(string="Qty",tracking=True, default="0")
    confirm_qty = fields.Interger(string="Confirm Qty", required=True, tracking=True, default="0")
    total_qty = fields.Interger(string="Total Qty", required=True, tracking=True, default="0")
    balance_qty = fields.Interger(string="Total Qty", required=True, tracking=True, default="0")
...
class VcsPrintTag(models.Model):
    ...
    parm_id = fields.Interger(string="Print TAG ID",required=True,tracking=True)
    seq = fields.Interger(string="Seq", tracking=True, default="0")
